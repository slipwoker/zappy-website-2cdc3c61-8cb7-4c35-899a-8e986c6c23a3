document.addEventListener('DOMContentLoaded', function () {
  ...
  function validateForm(form) {
    ...
    fields.forEach(function (field) {
      ...
      var fieldName = field.getAttribute('data-label') || field.name || field.id || field.type;

      if (field.hasAttribute('required') && !value) {
        showFieldError(field, (field.getAttribute('data-required-msg') || 'This field is required.'));
        isValid = false;
        return;
      }
      ...
      if (value && field.type === 'email') {
        ...
        if (!emailPattern.test(value)) {
          showFieldError(field, (field.getAttribute('data-email-msg') || 'Please enter a valid email address.'));
          isValid = false;
          return;
        }
      }
      ...
      if (value && field.type === 'tel') {
        ...
        if (!telPattern.test(value)) {
          showFieldError(field, (field.getAttribute('data-tel-msg') || 'Please enter a valid phone number.'));
          isValid = false;
          return;
        }
      }
      ...
      if (value && minLength && value.length < parseInt(minLength, 10)) {
        showFieldError(field, (field.getAttribute('data-minlength-msg') || 'This field must be at least ' + minLength + ' characters.'));
        isValid = false;
        return;
      }

      var maxLength = field.getAttribute('maxlength');
      if (value && maxLength && value.length > parseInt(maxLength, 10)) {
        showFieldError(field, (field.getAttribute('data-maxlength-msg') || 'This field must not exceed ' + maxLength + ' characters.'));
        isValid = false;
      }
    });
  ...
  function clearFormErrors(form) {
    ...
    form.querySelectorAll('.form-status-message').forEach(function (el) {
      el.remove();
    });
  }
  ...
  var animatedAttr = 'data-animate';

  var elementsToAnimate = document.querySelectorAll(
    '[' + animatedAttr + '], .animate-on-scroll, .fade-in, .slide-up, .slide-in'
  );
    ...
    if ('IntersectionObserver' in window) {
      ...
      function checkElementsInView() {
        ...
        elementsToAnimate.forEach(function (el) {
          ...
          var triggerPoint = scrollTop + windowHeight - 60;
    ...
    (function() {
        ...
        function initContactForm() {
            ...
            try {
                ...
                const payload = {
                    websiteId: '2cdc3c61-8cb7-4c35-899a-8e986c6c23a3',
                    name: name,
                    email: email,
                    subject: subject,
                    message: message,
                ...
                if (result.success) {
                    ...
                    if (result.thankYouPagePath && result.ticketNumber) {
                        ...
                        if (isPreviewMode && window.ZAPPY_CONFIG) {
                            ...
                            const websiteId = window.ZAPPY_CONFIG.websiteId || '2cdc3c61-8cb7-4c35-899a-8e986c6c23a3';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '2cdc3c61-8cb7-4c35-899a-8e986c6c23a3';
